...
Best described in `r2d3` documentation: [`r2d3 viewer argument`](https://rstudio.github.io/r2d3/articles/visualization_options.html#viewer).
...
by the `modelStudioOptions()` function. Full list of options:
[documentation](http://modelstudio.drwhy.ai/reference/modelStudioOptions.html).
...
package to explain various models. Bellow basic example of making `modelStudio` for a `mlr` model using `explain_mlr()`.
