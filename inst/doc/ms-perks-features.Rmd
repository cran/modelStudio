...
`modelStudio::modelStudio` computes various (instance and dataset level) model explanations and produces
...
Best described in `r2d3` documentation:
[`r2d3 viewer argument`](https://rstudio.github.io/r2d3/articles/visualization_options.html#viewer).
...
[documentation](http://modelstudio.drwhy.ai/reference/ms_options.html).
...
package to explain various models. Bellow basic example of making `modelStudio` for
a `mlr` model using `explain_mlr()`.
