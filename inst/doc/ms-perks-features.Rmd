...
[Explanatory Model Analysis](https://pbiecek.github.io/ema/) unite with tools for Exploratory Data Analysis 
...
and [Accumulated Dependence](https://pbiecek.github.io/ema/accumulatedLocalProfiles.html) Profiles (default is `300`). 
- `N_fi` is a number of observations used for calculation of
[Feature Importance](https://pbiecek.github.io/ema/featureImportance.html) (default is `10*N`).
- `B` is a number of permutation rounds used for calculation of
[Shapley Values](https://pbiecek.github.io/ema/shapley.html) (default is `10`).
- `B_fi` is a number of permutation rounds used for calculation of
[Feature Importance](https://pbiecek.github.io/ema/featureImportance.html) (default is `B`).
