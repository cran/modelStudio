...
In this example we will make a studio for the `ranger` model on `titanic` data.
...
In this example we will make a studio for the `gbm` model on `titanic` data.
...
In this example we will make a studio for the `h2o.automl` model on `titanic` data.
...
### parsnip [dashboard](https://modeloriented.github.io/modelStudio/parsnip.html)
...
In this example we will make a studio for the `Pipeline LGBMClassifier` model on `titanic` data.
...
In this example we will make a studio for the `Pipeline KerasClassifier` model on `titanic` data.
